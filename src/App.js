...
const ValentineProposal = () => {
    ...
    const messages = [
      "From the moment I first saw you, my heart knew you were special.",
      "Your smile brightens even my darkest days, and your laugh is my favorite melody.",
      ...
      "Your love has made me believe in magic and miracles.",
      "With you, every day feels like a romantic fairytale come true."
    ];
    ...
    useEffect(() => {
      ...
      const messageInterval = setInterval(() => {
        setCurrentMessage(prev => (prev + 1) % messageLength);
      }, 3000);
    ...
    return (
        <div className="container">
            ...
            <div className="content-wrapper">
                {!showProposal ? (
                    <button className="proposal-card" onClick={() => setShowProposal(true)}>
                        <Sparkles className="icon" />
                        <p className="message">
                            My dearest, I have something special to share with you...
                        </p>
                    </button>
                ) : (
                    <div className="proposal-card">
                        <h1 className="title">To My Beloved</h1>
                        <p className="message" key={currentMessage}>
                            {messages[currentMessage]}
                        </p>
                        <p className="message">
                            You are the missing piece to my puzzle, the answer to my prayers,
                            and the love of my life. Every moment with you is pure magic.
                        </p>
                        <div className="question">
                            I never imagined a world without you. This Propose Day, I want to make sure we never have to be apart.
                        </div>
                        <div className="question">
                            Happy Propose Day dear Ammu
                        </div>
                        {/* {!answer && (
            ...
            {answer === 'yes' && (
              <div className="success-message">
                ...
                Thank you for making this Valentine's Day perfect! 💖✨
              </div>
            )}
            {answer === 'no' && (
              <div className="message">
                Like the stars in the night sky, my love for you will forever shine... 💫
              </div>
            )} */}
                    </div>
                )}
